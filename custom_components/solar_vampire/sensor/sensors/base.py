"""Base sensor class for Solar Vampire sensors."""
import logging
...
class BaseSolarVampireSensor(SensorEntity, ABC):
    """Base class for all SolarVampire sensors."""
    ...
    def __init__(
        ...
        self.entity_id = f"sensor.{SENSOR_ID_PREFIX}_{unique_id_suffix}_1"
