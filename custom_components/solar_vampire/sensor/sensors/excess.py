"""Excess power sensor for Solar Vampire."""
import logging
...
class SolarVampireExcessSensor(BaseSolarVampireSensor):
    ...
    def _calculate_value(
        ...
        excess = calculate_excess_power(current_max_power, pv_power)
        
        # Calculate usage percentage
        usage = calculate_usage_percentage(pv_power, debug_info[KEY_PMAX])
        
        # Check if excess is possible
        excess_possible = is_excess_possible(pv_voltage, panel_params[KEY_VMP])
