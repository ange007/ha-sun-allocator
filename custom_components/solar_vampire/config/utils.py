"""Utility functions for Solar Vampire config flow."""
...
def get_boolean_entities(hass: HomeAssistant, exclude_keywords: Optional[List[str]] = None) -> List[str]:
    ...
    if exclude_keywords is None:
        exclude_keywords = ["solar_vampire", "solarvampire"]
    ...
    for domain in boolean_domains:
        ...
        for entity_id in domain_entities:
            ...
            if entity and entity.state in ["on", "off"]:
...
def get_default_value_for_dropdown(value: Any, none_string: str = "None") -> str:
