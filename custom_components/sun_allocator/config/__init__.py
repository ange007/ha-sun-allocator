...
from ..core.logger import log_warning, log_debug
from ..config.ui_helpers import SelectSelectorBuilder
...
class SunAllocatorConfigFlow(
    ...
    async def async_step_devices(self, user_input=None):
        ...
        schema_dict[
            ...
            translation_key="options.step.devices_action_options"
        ).build()
...
class SunAllocatorOptionsFlowHandler(
            ...
            data_schema=vol.Schema(
                {
                    vol.Required(
                        ...
                        "select": {
                            ...
                            "translation_key": "options.step.main_menu_action_options"
                        }
                    }),
                }
            ),
    ...
    async def async_step_manage_devices(self, user_input=None):
        ...
        schema_dict[
            ...
            "select": {
                "options": action_options,
                "translation_key": "options.step.manage_devices_action_options"
            }
        })
