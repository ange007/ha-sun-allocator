...
class SunAllocatorDevicePowerSensor(SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry_id: str, device_config: Dict[str, Any]):
    ...
    def _update_state(self):
        ...
        if not self._hass.data.get(DOMAIN) or not self._hass.data[DOMAIN].get(self._entry_id):
            return
        ...
        allocated_power = (pd_data.get("allocation", {}) or {}).get(self._device_id, 0.0)
