...
from custom_components.sun_allocator.core.solar_optimizer import calculate_current_max_power
...
@pytest.mark.parametrize("temp_diff,voc_coef,pmax_coef,expected_factor", [
...
async def test_temperature_compensation(temp_diff, voc_coef, pmax_coef, expected_factor):
